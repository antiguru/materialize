...
// TODO(mh): This had `could_error = false`, but not clear if true.
#[sqlfunc(
    ArrayCreate,
...
#[sqlfunc(Replace, sqlname = "replace", could_error = false)]
