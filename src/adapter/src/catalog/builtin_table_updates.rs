...
use mz_catalog::builtin::{
    ...
    MZ_CLUSTER_REPLICA_SIZES, MZ_CLUSTER_SYSTEM_PARAMETERS, MZ_COLUMNS, MZ_COMMENTS,
    ...
    MZ_PSEUDO_TYPES, MZ_REPLACEMENTS, MZ_REPLICA_SYSTEM_PARAMETERS, MZ_ROLE_AUTH, MZ_SESSIONS,
